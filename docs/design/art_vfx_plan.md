...
- [x] E3 파티클 텍스처 업그레이드 (§5.4) — WO-7: glow/spark ADD 블렌드 + 계열 틴트, 블랙홀·중력장 필드 타일 텍스처 회전 연출, 전부 프로시저럴 폴백 유지 (2026-07-07)
- [x] E4 스프라이트시트 애니메이션 — WO-8: 폭발·소멸 시트(4×4 16프레임) 격파/Plasma/T5 소멸 연결, 시트 없으면 폴백 (2026-07-07)
